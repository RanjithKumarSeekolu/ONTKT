...
?>
  <form action="<?php echo $url; ?>" name="frm1" method="post">
      <!--<p>Please wait.......<?php echo $_SESSION["name"];?>-->
     ...
     <!-- <input type="hidden" name="adults" value='<?php $adults=$_POST['adults']; echo $adults; ?>' />
      <input type="hidden" name="children" value='<?php $children=$_POST['children']; echo $children ?>' /> -->
  </form>
</body>
</html>
